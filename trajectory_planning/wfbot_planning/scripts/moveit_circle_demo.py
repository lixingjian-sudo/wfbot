...
class MoveItCircleDemo:
    def __init__(self):
        ...
        target_pose.pose.orientation.x = 0.39732387372378375
        target_pose.pose.orientation.y = 0.5852890176792817
        target_pose.pose.orientation.z = 0.3970750442953365
        target_pose.pose.orientation.w = 0.5847237932143732
        ...
        x = 0.35 
        y = 0.05 
        for th in numpy.arange(0,3.14, 0.02):
